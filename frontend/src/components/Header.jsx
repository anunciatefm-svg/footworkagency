...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 xl:px-8 h-20 flex items-center justify-between gap-3">
        <button
        ...
        <nav className="hidden xl:flex items-center gap-0">
          {NAV.map((n) => (
            <button
              ...
              className="px-2 py-2 text-[10px] 2xl:text-[11px] uppercase tracking-[0.16em] 2xl:tracking-[0.2em] text-white/70 hover:text-white transition-colors font-medium whitespace-nowrap"
            >
              {n.label}
            </button>
          ))}
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <a
            ...
            className="hidden md:inline-flex items-center gap-2 bg-[#0066CC] hover:bg-[#0052A3] text-white text-[10px] 2xl:text-xs font-bold uppercase tracking-[0.16em] 2xl:tracking-widest px-3 2xl:px-4 py-3 transition-colors shrink-0 whitespace-nowrap"
          >
